...
REM Change me vvvvv
SET ECR_CONTAINER_NAME=working_test_ecr
SET LAMBDA_ROLE_NAME=basic-lambda-role
SET REQUEST_TYPE=GET
REM Change me vvvvv
SET APIHASH=ibp5s1otjd
...
REM if you are doing an update to an already existing function, this will tie your lambda to your API
